          ...
          <div class="row" style="margin-top:50px;">
              ...
              <div class="wrapper-form">
                <form method='post' action="index.php?controller=account&action=registerPost">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="Ten" class="input-control">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="SDT" class="input-control">
                  </div>
                  <div class="form-group">
                    <label>Mật khẩu:<b id="req">*</b></label>
                    <input type="password" name="MatKhau" class="input-control" required="">
                  </div>
                  <div class="form-group">
            ...
            <div class="col-md-6">
              <div class="wrapper-form">
                ...
                <p>Đăng nhập tài khoản nếu bạn đã có tài khoản. Đăng nhập tài khoản để đăng ký tiêm chủng vaccine.</p>
